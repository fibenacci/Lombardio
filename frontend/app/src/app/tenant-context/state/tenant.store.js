...
import { useAuthStore } from "../../session/state";
import { fetchTenantFeatures, fetchTenants } from "../../../modules/tenants/infrastructure/api/tenants.api";
...
export const useTenantStore = defineStore("tenant", {
  ...
  getters: {
    ...
    hasFeature: (state) => (featureKey) =>
      state.features.some((feature) => feature.featureKey === featureKey && feature.enabled)
  },
