package io.lombardio.aml.infrastructure.persistence.entity;
...
@Entity
@Table(name = "aml_cases", schema = "aml")
public class AmlCaseEntity {
    ...
    public AmlRiskLevel getRiskLevel() { return riskLevel; }
    public void setRiskLevel(AmlRiskLevel riskLevel) { this.riskLevel = riskLevel; }
    ...
    public boolean isUnusualTransactionFlag() { return unusualTransactionFlag; }
    public void setUnusualTransactionFlag(boolean unusualTransactionFlag) { this.unusualTransactionFlag = unusualTransactionFlag; }
    public boolean isSourceOfFundsChecked() { return sourceOfFundsChecked; }
    public void setSourceOfFundsChecked(boolean sourceOfFundsChecked) { this.sourceOfFundsChecked = sourceOfFundsChecked; }
    public boolean isSuspiciousActivityReported() { return suspiciousActivityReported; }
    public void setSuspiciousActivityReported(boolean suspiciousActivityReported) { this.suspiciousActivityReported = suspiciousActivityReported; }
    public String getGoamlReference() { return goamlReference; }
    public void setGoamlReference(String goamlReference) { this.goamlReference = goamlReference; }
