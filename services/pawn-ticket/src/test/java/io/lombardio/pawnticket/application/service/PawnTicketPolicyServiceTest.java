...
class PawnTicketPolicyServiceTest {
    ...
    private final PawnTicketPolicyService service = new PawnTicketPolicyService(
    ...
    void shouldCalculatePartialRepaymentSettlement() {
        var settlement = service.settlePartial(new PawnTicketSettlementCommand(new BigDecimal("200.00"), new BigDecimal("50.00"), 3, null, null));
    ...
    void shouldCalculateRedemptionAmount() {
        var settlement = service.redeem(new PawnTicketSettlementCommand(new BigDecimal("200.00"), null, 3, null, null));
    ...
    void shouldIssueAndLoadStructuredPawnTicket() {
        var issued = service.issue(
                new IssuePawnTicketCommand(
                        ...
                        "Anna Becker",
                        "+49 170 111111",
                        List.of(new io.lombardio.pawnticket.domain.model.PawnTicketPosition(null, null, "Goldring 585", "Gelbgold 14 Karat", new BigDecimal("180.00"))),
    ...
    void shouldListIssuedTicketsForTenant() {
        ...
        service.issue(
                new IssuePawnTicketCommand(
                        ...
                        "Murat Yilmaz",
                        "+49 170 222222",
                        List.of(new io.lombardio.pawnticket.domain.model.PawnTicketPosition(null, null, "Apple iPhone 14", "128GB", new BigDecimal("260.00"))),
