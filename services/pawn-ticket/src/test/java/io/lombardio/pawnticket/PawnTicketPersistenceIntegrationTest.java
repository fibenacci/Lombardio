...
class PawnTicketPersistenceIntegrationTest {
  ...
  @Autowired private PawnTicketPolicyService pawnTicketPolicyService;

  @Autowired private PawnTicketRepository pawnTicketRepository;
            ...
            new IssuePawnTicketCommand(
                ...
                List.of(
                    new PawnTicketPosition(
                        null, null, "Ring", "585 Gold", new BigDecimal("120.00")),
                    new PawnTicketPosition(
                        null, null, "Kette", "750 Gold", new BigDecimal("80.00"))),
