alter table pawn_ticket.pawn_tickets
...
update pawn_ticket.pawn_tickets
...
create unique index if not exists idx_pawn_tickets_contract_number
    on pawn_ticket.pawn_tickets (contract_number);

alter table pawn_ticket.pawn_ticket_positions
    add column if not exists item_number varchar(120);

alter table pawn_ticket.pawn_ticket_positions
    add column if not exists item_barcode varchar(120);

update pawn_ticket.pawn_ticket_positions position
...
from pawn_ticket.pawn_tickets ticket
