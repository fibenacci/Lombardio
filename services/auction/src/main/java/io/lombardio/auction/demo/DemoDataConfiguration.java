 ...
 */
package io.lombardio.auction.demo;

import io.lombardio.auction.bootstrap.AuctionDevelopmentSeeder;
...
class DemoDataConfiguration {
  ...
  ApplicationRunner seedDemoData(AuctionDevelopmentSeeder seeder) {
