package io.lombardio.customer.portal.application;

import io.lombardio.customer.domain.model.Customer;
import io.lombardio.customer.domain.port.CustomerRepository;
import io.lombardio.customer.portal.api.CustomerPortalAcceptInvitationRequest;
import io.lombardio.customer.portal.api.CustomerPortalInvitationResponse;
import io.lombardio.customer.portal.api.CustomerPortalLoginRequest;
import io.lombardio.customer.portal.api.CustomerPortalLoginResponse;
import io.lombardio.customer.portal.api.CustomerPortalMeResponse;
import io.lombardio.customer.portal.api.CustomerPortalPawnTicketResponse;
import io.lombardio.customer.portal.infrastructure.notification.CustomerPortalNotificationSender;
import io.lombardio.customer.portal.infrastructure.persistence.CustomerPortalCredentialEntity;
import io.lombardio.customer.portal.infrastructure.persistence.CustomerPortalInvitationEntity;
import io.lombardio.customer.portal.infrastructure.persistence.CustomerPortalSessionEntity;
import io.lombardio.customer.portal.infrastructure.persistence.CustomerPortalCredentialRepository;
import io.lombardio.customer.portal.infrastructure.persistence.CustomerPortalInvitationRepository;
import io.lombardio.customer.portal.infrastructure.persistence.CustomerPortalSessionRepository;
import io.lombardio.customer.portal.infrastructure.security.AuthenticatedCustomerPortalUser;
import io.lombardio.customer.portal.infrastructure.ticket.CustomerPortalTicketClient;
