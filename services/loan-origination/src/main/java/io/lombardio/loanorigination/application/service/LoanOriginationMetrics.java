...
public class LoanOriginationMetrics {
    ...
    public LoanOriginationMetrics(MeterRegistry meterRegistry) {
        ...
        this.createdCounter = Counter.builder("lombardio.loan_origination.created")
                .description("Successfully created loan originations")
                .register(meterRegistry);
        this.loanAmountSummary = DistributionSummary.builder("lombardio.loan_origination.loan_amount")
                .baseUnit("eur")
    ...
    public void recordRejected(String reason) {
        meterRegistry.counter(
                "lombardio.loan_origination.rejected",
                "reason",
