...
import io.lombardio.identityaccess.auth.security.BearerTokenAuthenticationFilter;
    ...
    SecurityFilterChain securityFilterChain(
        ...
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/api/v1/auth/login", "/api/v1/auth/mfa/totp/verify", "/api/v1/auth/health", "/actuator/health").permitAll()
