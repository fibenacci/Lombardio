...
public class OnlineAuctionEntity {
    ...
    public OnlineAuctionStatus getStatus() { return status; }
    public void setStatus(OnlineAuctionStatus status) { this.status = status; }
    ...
    public Instant getCountdownEndsAt() { return countdownEndsAt; }
    public void setCountdownEndsAt(Instant countdownEndsAt) { this.countdownEndsAt = countdownEndsAt; }
    ...
    public List<OnlineAuctionLotEntity> getLots() { return lots; }
    public void setLots(List<OnlineAuctionLotEntity> lots) { this.lots = lots; }
    public List<BidderRegistrationEntity> getRegistrations() { return registrations; }
    public void setRegistrations(List<BidderRegistrationEntity> registrations) { this.registrations = registrations; }
}
