...
public class OnlineAuctionLotEntity {
    ...
    public String getHighestBidderAlias() { return highestBidderAlias; }
    public void setHighestBidderAlias(String highestBidderAlias) { this.highestBidderAlias = highestBidderAlias; }
}
