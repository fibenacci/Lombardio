...
public class IntegrationOutboxPersistenceAdapter implements IntegrationOutboxEventRepository {
    ...
    public IntegrationOutboxPersistenceAdapter(SpringDataIntegrationOutboxEventRepository repository) {
    ...
    public List<IntegrationOutboxEvent> findClaimable(Instant now, int limit) {
        return repository.findByStatusAndNextAttemptAtLessThanEqualOrderByOccurredAtAsc(
